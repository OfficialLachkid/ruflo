...
- Subject line is SHORT and CURIOSITY-DRIVEN — 2 to 4 words, lowercase, no marketing/salesy phrasing, no "gratis", no "aanbieding", no exclamation marks, no emoji, no company name, no "vraag over X". It should read like something a real person would send, not a campaign. Prefer a short reference to their site or the concrete thing you noticed, e.g. "uw website", "website crash", "even iets opgevallen", "korte vraag", "over uw site". Never long-form and never a full sentence pitch. Goal: make them open it out of curiosity, not because it looks like an ad.`;
